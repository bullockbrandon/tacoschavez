...
(function(){
    ...
    if(float_switcher_open_direction == 'left' || float_switcher_open_direction == 'right') {
        ...
        widget_css += '.gt_float_switcher .gt_options a{display:inline-block;text-decoration:none;padding:'+(flag_style=='3d'?6:10)+'px 15px;color:#7d7;transition:color .4s linear}';
        ...
        widget_css += '.gt_float_switcher .gt_options a{display:block;text-decoration:none;padding:'+(flag_style=='3d'?6:10)+'px 15px;color:#7d7;transition:color .4s linear}';
    ...
    widget_css += '.gt_float_switcher .gt-selected .gt-current-lang{padding:'+(flag_style=='3d'?6:10)+'px 15px;color:#7d7;font-weight:bold}';
